...
** sh_type_args_cmds.c
*/
bool			sh_type_args_cmds(t_btype *new, char **argv, int i,
	t_main *main);
void			sh_type_args_cmds_write(t_btype *new, char **argv, int i,
	t_main *main);
...
** sh_cd_fin.c
*/
char			*sh_chdir_finish(t_exec *exec, t_main *main, bool param,
	int8_t p);
void			sh_chdir_and_env(t_main *main, t_exec *exec, bool param,
	int8_t p);
/*
** sh_cd_path.c
*/
...
int				sh_echo_with_changes(char **str, int j, int flags[2],
	t_main *main);
...
void			sh_builtin_setenv_new_env(t_exec *exec, t_main *main, char *tmp,
	int i);
void			sh_builtin_setenv_change_env(t_exec *exec, t_main *main,
	char *tmp, int i);
/*
